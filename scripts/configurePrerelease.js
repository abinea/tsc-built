...
function main() {
    ...
    if (args.length < 3) {
        const thisProgramName = (0, path_1.relative)(process.cwd(), __filename);
        console.log("Usage:");
    ...
    const packageJsonFilePath = (0, path_1.normalize)(args[1]);
    const packageJsonValue = JSON.parse((0, fs_1.readFileSync)(packageJsonFilePath).toString());
    ...
    const tsFilePath = (0, path_1.normalize)(args[2]);
    const tsFileContents = (0, fs_1.readFileSync)(tsFilePath).toString();
    ...
    (0, fs_1.writeFileSync)(packageJsonFilePath, JSON.stringify(packageJsonValue, /*replacer:*/ undefined, /*space:*/ 4));
    (0, fs_1.writeFileSync)(tsFilePath, modifiedTsFileContents);
}
...
main();
//# sourceMappingURL=configurePrerelease.js.map